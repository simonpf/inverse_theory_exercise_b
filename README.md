...
![img](./docs/plots/gpm.png "The Global Precipitation Measurement Microwave Imager onboard the GPM core observatory satellite.")
...
4.  Retrieving the Posterior CDF
    ...
    ![img](./docs/plots/cdf_example.png "Posterior CDF for entry 14325 in the database.")
...
5.  Apply your Retrieval
    ...
    ![img](./docs/plots/saola_overview.png "The tropical storm Saola seen from Modis and GMI (`gmi_tbs_0`).")
