#+TITLE: Inversion Theory: Exercise B
...
**** Retrieving the Posterior CDF
     ...
     Given the CDF of the posterior what is your "best estimate" for the retrieval? And how
     does this compare to the expected value for the validation data set.
